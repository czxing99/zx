...
import com.zx.po.mysql.SelectDetail;
...
@Service
public class RInventoryClassService {
    @Resource
    ...
    public List<InventoryClass> querylast(){
    ...
    public boolean updateReceiveInventory(List<InventoryClass> lists){
       ...
       for(InventoryClass inventoryClass:lists){
           ...
           selectDetail.setPid(1);
           selectDetail.setText(inventoryClass.getName());
           selectDetail.setDef(0);
           selectDetailMapper.insert(selectDetail);
